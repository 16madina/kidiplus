...
-- Payout caps by tier + currency (~USD tiers; XOF via EUR peg).
...
-- Sum non-rejected payouts for a user/currency in a time window.
...
-- Admin can flip KYC flag (Stripe Identity UI later).
