...
GRANT SELECT ON public.vitrine_posts TO anon;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.vitrine_posts TO authenticated;
GRANT ALL ON public.vitrine_posts TO service_role;
...
GRANT SELECT ON public.vitrine_likes TO anon;
GRANT SELECT, INSERT, DELETE ON public.vitrine_likes TO authenticated;
GRANT ALL ON public.vitrine_likes TO service_role;
...
GRANT SELECT ON public.vitrine_comments TO anon;
GRANT SELECT, INSERT, DELETE ON public.vitrine_comments TO authenticated;
GRANT ALL ON public.vitrine_comments TO service_role;
...
GRANT SELECT ON public.vitrine_stories TO anon;
GRANT SELECT, INSERT, DELETE ON public.vitrine_stories TO authenticated;
GRANT ALL ON public.vitrine_stories TO service_role;
