...
function NotFoundComponent() {
  useEffect(() => {
    // Soft profile paths that somehow missed their route → send home + open section.
    void import("@/lib/soft-profile-routes").then(({ softSectionFromPath, stashSoftSection }) => {
      const section = softSectionFromPath(window.location.pathname);
      if (!section) return;
      stashSoftSection(section);
