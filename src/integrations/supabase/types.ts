  ...
  public: {
    Tables: {
      ...
      vitrine_comments: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "vitrine_posts"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "vitrine_comments_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      vitrine_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "vitrine_likes_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "vitrine_posts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vitrine_likes_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      vitrine_posts: {
        ...
        Relationships: [
          {
            foreignKeyName: "vitrine_posts_live_id_fkey"
            columns: ["live_id"]
            isOneToOne: false
            referencedRelation: "lives"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vitrine_posts_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      vitrine_stories: {
        ...
        Relationships: [
          {
            foreignKeyName: "vitrine_stories_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
