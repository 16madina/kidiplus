...
import bg2 from "@/assets/welcome-bgs/auth-bg-2.png.asset.json";
import bg3 from "@/assets/welcome-bgs/auth-bg-3.png.asset.json";
import bg4 from "@/assets/welcome-bgs/auth-bg-4.png.asset.json";

const WELCOME_BGS = [bg1, bg2, bg3, bg4];
