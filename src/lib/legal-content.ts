  ...
  terms: {
    ...
    sections: [
      ...
      { h: "8. Payments, wallet and fees", p: [
        ...
        `Payouts are subject to a minimum threshold, to timeframes specific to the chosen method, and to anti-fraud and compliance checks. ${APP_NAME} may suspend or refuse a payout suspected of fraud pending full verification.`,
